...
public class PersonViewModel : INotifyPropertyChanged
{
    ...
    private void BuildPersons()
    {
        Person[] personArray = [
            ...
            new Person { FirstName = "Clark", LastName="Kent", Email = "clark@dailyplanet.com", Code = "Kal-El", Department="Justice" },
            ...
            new Person { FirstName = "Jyn", LastName="Erso", Email = "jyn@rebel-alliance.org", Code = "Rogue One", Department="Rebels" },
            ...
            new Person { FirstName = "Marty", LastName="McFly", Email = "marty@hillvalley.net", Code = "OUTATIME", Department="Hill Valley" },
            new Person { FirstName = "Dave", LastName="Lister", Email = "dave@jupitermining.com", Code = "Starbug", Department="Red Dwarf" },
